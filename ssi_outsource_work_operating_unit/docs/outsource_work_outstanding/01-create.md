...
- **Operating Unit**: the operating unit that owns this outstanding document. Not
...
- The **Outstandings** list is filtered by operating unit (record rule). A user only
  sees outstanding documents whose Operating Unit is one of the operating units assigned
