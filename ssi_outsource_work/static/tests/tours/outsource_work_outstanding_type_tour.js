odoo.define("ssi_outsource_work.outsource_work_outstanding_type_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [
            // Flow 1 — Open the Outsource Work > Configuration > Outstanding
            // Types menu
            ...
            {
                content: "Open the Outstanding Types menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_outsource_work.outsource_work_outstanding_type_menu"]',
            },
            {
                content: "Outstanding Types list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(Outstanding Types)",
            ...
            // Flow 3 — Fill in the required fields
            {
                ...
                run: "text TOUR Outstanding Type",
            },
            {
            ...
            {
                content: "Select the Payable Journal",
                trigger: ".o_field_many2one[name='payable_journal_id'] input",
                run: "text TOUR Fixture Journal",
            },
            {
                content: "Pick the Payable Journal from the dropdown",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR Fixture Journal)",
                in_modal: false,
            },
            {
                content: "Select the Payable Account",
                trigger: ".o_field_many2one[name='payable_account_id'] input",
                run: "text TOUR Fixture Payable Account",
            },
            {
                content: "Pick the Payable Account from the dropdown",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR Fixture Payable Account)",
                in_modal: false,
            },
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Find and open the record to edit
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Edit Outstanding Type) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
            ...
            // Flow 3 — Change the Name field
            {
                ...
                trigger: ".o_field_widget[name='name']",
                extra_trigger: ".o_form_view.o_form_editable",
                run: "text TOUR Edit Outstanding Type Renamed",
            },
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the record to delete
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR Delete Outstanding Type) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
            ...
            {
                content: "Click the Outstanding Types breadcrumb to return to the list",
                trigger: ".breadcrumb-item.o_back_button a:contains(Outstanding Types)",
            },
            {
                content: "Record no longer appears in the list",
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Delete Outstanding Type)))",
                run: function () {
                    // Assertion only.
                },
            },
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the record and click Edit
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR Deactivate Outstanding Type) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Click the Edit button",
    ...
    tour.register(
        ...
        [
            ...
            // Flow 3 — Select the record and unarchive it
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Activate Outstanding Type) .o_list_record_selector input",
                run: "click",
            },
            {
                content: "Open the Action menu",
            ...
            // default list view (it drops out of the Archived-only list).
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Activate Outstanding Type)))",
                run: function () {
                    // Assertion only.
                },
            },
