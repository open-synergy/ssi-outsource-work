odoo.define("ssi_outsource_work.outsource_work_type_category_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            // Flow 1 — Open the Outsource Work > Configuration > Work Category
            // Types menu
            ...
            {
                content: "Open the Work Category Types menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_outsource_work.outsource_work_type_category_menu"]',
            },
            {
                content: "Work Category Types list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(Work Category Types)",
    ...
    tour.register(
        ...
        [
            ...
            // Flow 3 — Change the Name field
            {
                ...
                trigger: ".o_field_widget[name='name']",
                extra_trigger: ".o_form_view.o_form_editable",
                run: "text TOUR Edit Category Renamed",
            },
    ...
    tour.register(
        ...
        [
            ...
            {
                content:
                    "Click the Work Category Types breadcrumb to return to the list",
                trigger:
                    ".breadcrumb-item.o_back_button a:contains(Work Category Types)",
            },
            {
    ...
    tour.register(
        ...
        [
            ...
            // Flow 3 — Select the record and unarchive it
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Activate Category) .o_list_record_selector input",
                run: "click",
            },
            {
                content: "Open the Action menu",
            ...
            // default list view (it drops out of the Archived-only list).
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Activate Category)))",
                run: function () {
                    // Assertion only.
                },
            },
